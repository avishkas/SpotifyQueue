...
def hostLogin():
	...
	query = {'client_id' : '', 'response_type' : 'code','redirect_uri' : 'http://localhost:5000/afterLogin', 'scope' : 'playlist-modify-public'}
...
def afterLogin():
	...
	params = {'grant_type' : 'authorization_code', 'code' : code, 'redirect_uri' : 'http://localhost:5000/afterLogin', 'client_id': '', 'client_secret' : ''}
